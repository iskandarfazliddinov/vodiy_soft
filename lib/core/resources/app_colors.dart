...
class AppColors {
  ...
  static const Color green = Color(0xFF63CC49);
  ...
  static const Color defaults = Color(0xFF67757C);
  static const Color info = Color(0xFF20AEE3);
  static const Color warning = Color(0xFFFE9347);
  static const Color success = Color(0xFF24D2B5);
